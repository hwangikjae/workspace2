package com.jojoldu.admin.springboot.web.domain.posts;
...
public class PostsRepositoryTest {
    ...
    //보통은 배포 전 전체 테스트를 수행할 때 테스트간 침범을 막기위해 사용
    //여러 테스트가 동시에 수행되면 테스트용 데이터베이스인 h2에 데이터가 그대로 남아있어 다음 테스트가 실패할 수 있다!
    public void cleanup(){
